                ...
                <div class="register__block">
                    ...
                    <div class="register__inputFields">
                        <form action="{{route('register-form')}}" method="post">
                            ...
                            <div class="register__inputField"><input name="phone" id="phone" type="text" placeholder="Телефон"></div>
                            <div class="register__inputField"><input name="birth_date" id="birth_date" type="text" placeholder="Дата рождения"></div>
                            <div class="register__inputField"><input name='password' id="password" type="text" placeholder="Пароль"></div>
